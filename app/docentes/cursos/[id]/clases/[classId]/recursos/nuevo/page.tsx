    ...
    <div className="flex-1 p-6 md:p-12 overflow-y-auto w-full h-full">
      ...
      <header className="mb-10 md:mb-16 max-w-2xl">
        <div className="flex flex-wrap items-center gap-3 mb-6 md:mb-8">
          ...
          <span className="px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest md:ml-4 bg-[var(--color-surface-container-highest)] text-[var(--color-on-surface-variant)]">
            {classData.title}
          </span>
        </div>
