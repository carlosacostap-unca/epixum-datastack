      ...
      <main className="ml-64 min-h-screen px-12 py-10">
        <header className="mb-12 max-w-6xl mx-auto">
          <div className="flex items-center gap-2 text-on-surface-variant mb-4">
            ...
            <Link href={`/courses/${course.id}/assignments`} className="hover:text-indigo-400 transition-colors text-[11px] font-bold uppercase tracking-widest">
              Trabajos Prácticos
            </Link>
            <span className="material-symbols-outlined text-xs">chevron_right</span>
            <span className="text-[11px] font-bold uppercase tracking-widest text-indigo-400">Nuevo Trabajo Práctico</span>
          </div>
          <h1 className="text-[36px] font-headline font-medium tracking-tight text-on-surface mb-2">Nuevo Trabajo Práctico</h1>
          <p className="text-on-surface-variant font-body text-lg">Define las consignas y la fecha de entrega para los alumnos.</p>
        </header>
