...
import { createClassForCourse, getResourceUploadUrl, createLink } from "@/lib/actions";
...
export default function NewClassForm({ courseId }: NewClassFormProps) {
      ...
      for (const resource of pendingResources) {
        try {
          ...
          if (finalUrl) {
            ...
            linkFormData.append('classId', result.classId);
    ...
    <section className="grid grid-cols-12 gap-8">
      ...
      <div className="col-span-12 lg:col-span-7 space-y-10">
        <div className="glass-panel p-10 rounded-xl">
          <form id="new-class-form" onSubmit={handleSubmit} className="space-y-12">
            {error && (
            ...
            <div className="space-y-4">
              ...
              <textarea 
                name="description"
                id="description" 
                placeholder="Escribe los objetivos y temas a tratar..." 
                rows={4}
                className="block w-full bg-white/5 border border-white/5 rounded-xl px-4 py-3 text-on-surface focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300 outline-none placeholder:text-white/20"
              ></textarea>
            </div>
        ...
        <div className="glass-panel p-8 rounded-xl">
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-on-surface-variant text-xs mt-1">PDF, MP4, PNG hasta 50MB</p>
            </div>
          </div>
